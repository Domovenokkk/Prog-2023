...
class TBitField {
private:
	size_t bitLen;                      // длина битового пол€ (максимальное допустимое значение эл-та мн-ва, мощность универса)
	size_t memLen;                      // кол-во элементов, необходимое дл€ хранени€ битового пол€
	elem_type* pMem;                    // пам€ть дл€ представлени€ битового пол€

	// служебные пол€ (не об€зательны)
	//size_t bitsInElem;
	//size_t shiftSize;

	// служебные методы

	// индекс в pћем дл€ бита pos
